...
.valid:
		...
		move.b	#1<<sprite_cam_field,obRender(a0)	; set render mode to playfield-positioned
...
Pow_Main:	; Routine 0
		...
		move.w	#ArtTile_Monitor,obGfx(a0)	; set art tile
		move.b	#1<<sprite_rawmappings|1<<sprite_cam_field,obRender(a0)		; set "raw-mappings" flag and playfield positioning mode
		move.b	#3,obPriority(a0)		; set sprite priority to 3
